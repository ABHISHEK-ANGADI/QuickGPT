...
const ChatBox = () => {
  ...
  return (
    ...
    {/* chat messages */}
      ...
      <form onSubmit={onSubmit} className='bg-primary/20 dark:bf-[#583C79]/30 border border-primary dark:border-[#80609F]/30 rounded-full w-full max-w-2xl p-3 pl-4 mx-auto flex gap-4 items-center'>
